...
class EquityBarrierTest(unittest.TestCase):
    ...
    def test_up_and_out(self):
        ...
        self.assertEqual(edf_call.value(self.r, num_observations_per_year, ul.getPrice(), notional).round(4), 0.1789)

        edf_put = BarrierOption("EDF-put", expiry, ul, K, B, EquityBarrierTypes.UP_AND_OUT_PUT)
        self.assertEqual(edf_put.value(self.r, num_observations_per_year, ul.getPrice(), notional).round(4), 18.1445)
    ...
    def test_up_and_in(self):
        ...
        self.assertEqual(edf_call.value(self.r, num_observations_per_year, ul.getPrice(), notional).round(4), 0.6898)

        edf_put = BarrierOption("EDF-put", expiry, ul, K, B, EquityBarrierTypes.UP_AND_IN_PUT)
        self.assertEqual(edf_put.value(self.r, num_observations_per_year, ul.getPrice(), notional).round(4), 0.0144)
    ...
    def test_down_and_in(self):
        ...
        self.assertEqual(edf_call.value(self.r, num_observations_per_year, ul.getPrice(), notional).round(4), 3.5522)

        edf_put = BarrierOption("EDF-put", expiry, ul, K, B, EquityBarrierTypes.DOWN_AND_IN_PUT)
        self.assertEqual(edf_put.value(self.r, num_observations_per_year, ul.getPrice(), notional).round(4), 10.747)
    ...
    def test_down_and_out(self):
        ...
        self.assertEqual(edf_call.value(self.r, num_observations_per_year, ul.getPrice(), notional).round(4), 4.9045)

        edf_put = BarrierOption("EDF-put", expiry, ul, K, B, EquityBarrierTypes.DOWN_AND_OUT_PUT)
        self.assertEqual(edf_put.value(self.r, num_observations_per_year, ul.getPrice(), notional).round(4), 1.0780)
